...
public class FireRayFX extends EntityFX {
    ...
    public FireRayFX(World par1World, double px, double py, double pz,
    ...
    public void renderParticle(Tessellator tessellator, float f, float f1,
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(EAClientProxy.FIRE_TEXTURE);
        tessellator.startDrawingQuads();
        this.prevSize = size;
        GL11.glDisable(2884);
        GL11.glPopMatrix();
